...
const createOrderStatusUpdateTemplate = (orderData) => {
  const {_id, user, contactInformation, shippingInformation, paymentInformation, orderSummary, status, orderDate} = orderData;
  ...
  const statusDetails = {
    ...
    'In Transit': {
      ...
      color: '#17A2B8',
      message: 'Your order is on its way and will be delivered soon!'
    },
    'Delivered': {
...
<body>
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9;">
        ...
        <div style="background-color: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 4px rgba(43, 37, 37, 0.1);">
            <div style="text-align: center; margin-bottom: 30px;">
                <i class="fas ${currentStatus.icon}" style="color: ${currentStatus.color}; font-size: 48px;"></i>
                <h2 style="color: ${currentStatus.color}; margin: 10px 0;">Order Status Update</h2>
            </div>
            ...
            <div style="text-align: center; margin: 25px 0;">
                <p style="font-size: 16px;">
                    <b>Current Status: </b>
                    <span style="background-color: ${currentStatus.color}; color: white; padding: 5px 15px; border-radius: 20px;">
                        <i class="fas ${currentStatus.icon}"></i> ${status}
                    </span>
                </p>
                <p style="color: #666;">
                    <i class="fas fa-calendar"></i> 
...
export default createOrderStatusUpdateTemplate;
...
export const sendUpdateOrderEmail = async (req, res) => {
...
const emailHtml = createOrderStatusUpdateTemplate({
      ...orderData,
      status: newStatus  // Override the current status with new status
    });
